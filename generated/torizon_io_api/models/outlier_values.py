...
class OutlierValues(BaseModel):
    """
    OutlierValues
    """ # noqa: E501
    metric_name: StrictStr = Field(alias="metricName")
    aggregation: OutlierAggregationMethod
    outliers: Optional[List[Outlier]] = None
    __properties: ClassVar[List[str]] = ["metricName", "aggregation", "outliers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outliers": [Outlier.from_dict(_item) for _item in obj["outliers"]] if obj.get("outliers") is not None else None
        })
        return _obj
