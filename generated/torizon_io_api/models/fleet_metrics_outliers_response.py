...
class FleetMetricsOutliersResponse(BaseModel):
    """
    FleetMetricsOutliersResponse
    """ # noqa: E501
    values: Optional[List[OutlierValues]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [OutlierValues.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
