...
class TestPaginationResultUpdateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginationResultUpdateResponse:
        """Test PaginationResultUpdateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginationResultUpdateResponse`
        """
        model = PaginationResultUpdateResponse()
        if include_optional:
    ...
    def testPaginationResultUpdateResponse(self):
        """Test PaginationResultUpdateResponse"""
