...
class TestLastSshSession(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LastSshSession:
        """Test LastSshSession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastSshSession`
        """
        model = LastSshSession()
        if include_optional:
            return LastSshSession(
