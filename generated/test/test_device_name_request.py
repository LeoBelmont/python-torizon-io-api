...
class TestDeviceNameRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeviceNameRequest:
        """Test DeviceNameRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceNameRequest`
        """
        model = DeviceNameRequest()
        if include_optional:
    ...
    def testDeviceNameRequest(self):
        """Test DeviceNameRequest"""
