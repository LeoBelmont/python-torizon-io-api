...
class TestFleetMetricsOutliersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FleetMetricsOutliersResponse:
        """Test FleetMetricsOutliersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FleetMetricsOutliersResponse`
        """
        model = FleetMetricsOutliersResponse()
        if include_optional:
    ...
    def testFleetMetricsOutliersResponse(self):
        """Test FleetMetricsOutliersResponse"""
